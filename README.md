...
This assignment based on the Knapsack problem [https://en.wikipedia.org/wiki/Knapsack_problem]() 

**Knapsack Algorithm**

I've used the dynamic programming implementation of 0-1 Knapsack problem with Java 8 stream api. (PackerCalculator)
